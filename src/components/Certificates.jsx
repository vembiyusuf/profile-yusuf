    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {certificates.map((cert, index) => (
          <motion.div
            key={index}
            className="bg-gray-900 p-6 rounded-lg border-2 border-gray-900 hover:border-sky-400 transition-all duration-300 hover:scale-[1.02]"
            custom={index}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          ...
          >
            <div className="flex justify-between items-center mb-4">
              ...
              <a href="#" className="bg-white rounded-full p-2 hover:bg-sky-400 transition-colors">
                <i className="bx bx-arrow-back text-2xl text-gray-900 rotate-180 hover:rotate-[360deg] transition-transform"></i>
              </a>
            </div>
